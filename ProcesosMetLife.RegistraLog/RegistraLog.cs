...
namespace ProcesosMetLife.RegistraLog
{
    public class RegistraLog
    {
        ...
        public bool Agregar(Exception excepcion)
        {
            try
            {
                LimpiarErrores();
                ...
                cadena += DateTime.Now + Environment.NewLine;
                cadena += "Mensaje: " + excepcion.Message + Environment.NewLine +
                "Fuente: " + excepcion.Source + Environment.NewLine + 
        ...
        public bool Seguimiento(string sLog)
        {
            try
            {
                LimpiarErrores();
                ...
                cadena += DateTime.Now + " - Seguimiento inserción: " + sLog + Environment.NewLine;
