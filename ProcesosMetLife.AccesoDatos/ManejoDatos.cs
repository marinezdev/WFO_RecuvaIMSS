...
namespace ProcesosMetLife.AccesoDatos
{
    internal sealed class ManejoDatos
    {
        ...
        internal int InsertUpdateDeleteWithTransaction()
        {
            ...
            {
                ProcesosMetLife.RegistraLog.RegistraLog log = new RegistraLog.RegistraLog("Log", HttpContext.Current.Server.MapPath("~"), "WFO Error Datos");
