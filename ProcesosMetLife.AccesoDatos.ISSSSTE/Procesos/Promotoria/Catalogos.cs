    ...
    public class Catalogos
    {
        ...
        public List<prop.cat_producto> Cat_Productos(int TipoTramite)
        {
            ...
            while (reader.Read())
            {
                prop.cat_producto item = new prop.cat_producto()
                {
                    ...
                    Id_TipoTramite = Funciones.Nums.TextoAEntero(reader["Id_TipoTramite"].ToString()),
        ...
        public List<prop.cat_subproducto> Cat_SubProductos(int Id)
        {
            ...
            while (reader.Read())
            {
                ...
                {
                    Id = Funciones.Nums.TextoAEntero(reader["Id"].ToString()),
                    Id_CatProducto = Funciones.Nums.TextoAEntero(reader["Id_CatProducto"].ToString()),
                    Nombre = reader["Nombre"].ToString(),
                    Descripcion = reader["Descripcion"].ToString()
                };
                resultado.Add(item);
        ...
        public List<prop.cat_moneda> Cat_Monedas()
        {
            ...
            while (reader.Read())
            {
                prop.cat_moneda item = new prop.cat_moneda()
                {
                    Id = Funciones.Nums.TextoAEntero(reader["Id"].ToString()),
                    Nombre = reader["Nombre"].ToString(),
                    Valor = Funciones.Nums.TextoADecimal(reader["Valor"].ToString())
                };
                resultado.Add(item);
            }
            reader = null;
        ...
        public List<prop.promotoria_usuario> Promotoria_Usuarios(int Id)
        {
            ...
            while (reader.Read())
            {
                prop.promotoria_usuario item = new prop.promotoria_usuario()
                {
                    ...
                    Promoria = reader["Promoria"].ToString()
                };
                resultado.Add(item);
            }
            reader = null;
        ...
        public List<prop.promotoria_usuario> Promotoria_Seleccionar_PorIdTramite(int Id_Promotoria, int Id_Tramite)
        {
            ...
            while (reader.Read())
            {
                prop.promotoria_usuario item = new prop.promotoria_usuario()
                {
                    Id = Funciones.Nums.TextoAEntero(reader["Id"].ToString()),
                    Clave = reader["Clave"].ToString(),
                    Promoria = reader["Promotoria"].ToString()
                };
                resultado.Add(item);
            }
            reader = null;
        ...
        public List<prop.cat_pais> cat_Pais_Sancionado (int Id)
        {
            ...
            while (reader.Read())
            {
                prop.cat_pais item = new prop.cat_pais()
                {
                    Sancionado = Funciones.Nums.TextoAEntero(reader["Sancionado"].ToString())
                };
                resultado.Add(item);
            }
            reader = null;
