...
using prop = ProcesosMetLife.Propiedades.Procesos.Operacion.Captura;

namespace ProcesosMetLife.AccesoDatos.ISSSTE.Procesos.Operacion.Captura
{
    public class Asegurados
    {
        ...
        public int Asegurados_Actualiza_UMAN_Agente(int IdTramite, string RFC, string agente, string UMAN, string FechaFirmaSolicitud, int IdEstado)
        {
            ...
            b.AddParameter("@FechaFirmaSolicitud", Funciones.Fechas.FormatoFechas(DateTime.Parse(FechaFirmaSolicitud), 4), SqlDbType.DateTime);
