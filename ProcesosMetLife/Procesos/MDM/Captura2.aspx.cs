...
{
    public partial class Captura2 : Utilerias.Comun
    {
        ...
        protected void BotonPresionado_Click(object sender, EventArgs e)
        {
            ...
            switch (valor.ID)
            {
                ...
                case "btnAceptar":
                    ...
                    items.IdUsuario = manejo_sesion.Usuarios.IdUsuario;
                    items.Numero = TextBox1.Text;
                    items.Poliza = TextBox2.Text;
                    items.GUID_ = TextBox3.Text;
                    ...
                    if (i.mdm.captura2.Agregar(items, "Captura2"))
