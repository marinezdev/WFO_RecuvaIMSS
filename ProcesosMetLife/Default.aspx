<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ProcesosMetLife.Default" %>
				...
				<hr>
                    <form id="form1" runat="server" class="login100-form validate-form">
                        ...
                        <div style="color:#835F34; text-align: center">
                            ...
                            <asp:Timer ID="Timer1" runat="server" Enabled="true" Interval="60" OnTick="Timer1_Tick"></asp:Timer>
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:Label runat="server" ID="Label1" Font-Bold="True" Font-Names="Tahoma" Font-Size="Medium" ForeColor="#003300" Visible="false" />
                                </ContentTemplate>
                                <Triggers>
